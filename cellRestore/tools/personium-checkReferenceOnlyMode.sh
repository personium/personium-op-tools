...
# プロパティ値取得
_MEMCACHED_HOST_FOR_LOCK_KEY="io.personium.core.cache.memcached.host"
_MEMCACHED_PORT_FOR_LOCK_KEY="io.personium.core.cache.memcached.port"
_UNIT_PREFIX_KEY="io.personium.core.es.unitPrefix"
