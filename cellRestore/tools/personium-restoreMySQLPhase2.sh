...
_UNIT_PREFIX=`getProp "io.personium.core.es.unitPrefix"`

#
# リストア元MySQL情報
#

_SOURCE_MYSQL_HOST=`getProp "io.personium.core.mysql.restore.work.host"`
_SOURCE_MYSQL_PORT=`getProp "io.personium.core.mysql.restore.work.port"`
_SOURCE_MYSQL_USER=`getProp "io.personium.core.mysql.restore.work.user.name"`
_SOURCE_MYSQL_PASSWORD=`getProp "io.personium.core.mysql.restore.work.user.password"`
_SOURCE_MYSQL_DATABASE="${_UNIT_PREFIX}_${_UNIT_USER_NAME}"

#
# リストア先MySQL情報
#
_TARGET_MYSQL_HOST=`getProp "io.personium.core.mysql.master.host"`
_TARGET_MYSQL_PORT=`getProp "io.personium.core.mysql.master.port"`
_TARGET_MYSQL_USER=`getProp "io.personium.core.mysql.master.user.name"`
_TARGET_MYSQL_PASSWORD=`getProp "io.personium.core.mysql.master.user.password"`
