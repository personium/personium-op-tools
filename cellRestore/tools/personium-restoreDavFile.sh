...
# なお、テンポラリテーブルへのデータ投入はpersonium-restoreMySQLPhase1にて実施している.
...
MYSQL_WORK_HOST=`getProp "io.personium.core.mysql.restore.work.host"`
MYSQL_WORK_PORT=`getProp "io.personium.core.mysql.restore.work.port"`
MYSQL_USER=`getProp "io.personium.core.mysql.restore.work.user.name"`
MYSQL_PASSWORD=`getProp "io.personium.core.mysql.restore.work.user.password"`

DAV_RESTORE_TARGET_DIR=`getProp "io.personium.core.webdav.basedir"`
DAV_WORK_SPACE=`getProp "io.personium.core.restore.workspace.webdav.dir"`
DAV_BKUP_FILE_PREFIX=`getProp "io.personium.core.backup.dav.prefix"`
