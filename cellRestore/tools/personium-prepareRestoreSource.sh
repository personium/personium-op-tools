...
# personium-prepareRestoreSource.sh - バックアップファイル存在チェック～バックアップデータ複写
# 引数：
# ・ユニットユーザ名
...
# 引数チェック
if [ $# -ne 2 ]; then
  outputErrorLog "Usage: personium-prepareRestoreSource.sh <unituser-name> <restore-target-date>"
  exit 1
fi
...
# プロパティファイルからの読み込み
UNIT_PREFIX=`getProp "io.personium.core.es.unitPrefix"`
MYSQL_PREFIX=`getProp "io.personium.core.backup.mysql.prefix"`
MYSQL_BACKUP_BASE_DIR=`getProp "io.personium.core.backup.mysql.dir"`
MYSQL_RESTORE_BASE_DIR=`getProp "io.personium.core.restore.workspace.mysql.dir"`
WEBDAV_BACKUP_PREFIX=`getProp "io.personium.core.backup.dav.prefix"`
WEBDAV_BACKUP_BASE_DIR=`getProp "io.personium.core.backup.dav.dir"`
WEBDAV_RESTORE_BASE_DIR=`getProp "io.personium.core.restore.workspace.webdav.dir"`
EVENTLOG_BACKUP_PREFIX=`getProp "io.personium.core.backup.eventlog.prefix"`
EVENTLOG_BACKUP_BASE_DIR=`getProp "io.personium.core.backup.eventlog.dir"`
EVENTLOG_RESTORE_BASE_DIR=`getProp "io.personium.core.restore.workspace.eventlog.dir"`
MYSQL_BACKUP_ARCHIVE=`getProp "io.personium.core.restore.mysql.archive.backup"`
