...
EVLOG_RESTORE_TARGET_DIR=`getProp "io.personium.core.eventlog.basedir"`
EVLOG_WORK_SPACE=`getProp "io.personium.core.restore.workspace.eventlog.dir"`
EVLOG_BKUP_FILE_PREFIX=`getProp "io.personium.core.backup.eventlog.prefix"`
