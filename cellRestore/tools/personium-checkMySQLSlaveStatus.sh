...
#
# Personium
# Copyright 2016 - 2017 - 2017 FUJITSU LIMITED
#
...
# プロパティファイルからの読み込み
MYSQL_SLAVE_HOST=`getProp "io.personium.core.mysql.slave.host"`
MYSQL_SLAVE_PORT=`getProp "io.personium.core.mysql.slave.port"`
MYSQL_SLAVE_USER=`getProp "io.personium.core.mysql.backup.user.name"`
MYSQL_SLAVE_PASSWORD=`getProp "io.personium.core.mysql.backup.user.password"`
